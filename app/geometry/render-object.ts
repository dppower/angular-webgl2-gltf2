...
export class RenderObject {
    ...
    static uniforms = ["uniform_color", "transform_matrix", "view_matrix", "projection_matrix", "normal_matrix"];
    ...
    constructor(@Inject(webgl2) private gl: WebGL2RenderingContext, loader: TextureLoader, object_data: RenderObjectData, private vertex_buffer: ObjectBuffer) {
